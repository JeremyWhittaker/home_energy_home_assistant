...
6. Restores the prior directory on validation/restart failure and retains the failed copy for inspection.
...
- four `input_number.home_energy_*` helpers;
...
- whole-home load is close to EG4 metered load plus Enphase power;
