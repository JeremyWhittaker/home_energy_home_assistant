...
const STATIC = Object.freeze({
  ...
  hvacResponseEnabled: "input_boolean.home_energy_hvac_response_enabled",
  hvacWindowStart: "input_datetime.home_energy_hvac_window_start",
  hvacWindowEnd: "input_datetime.home_energy_hvac_window_end",
  hvacSocGuardrail: "input_number.home_energy_hvac_soc_guardrail_percent",
  hvacSetpointIncrease: "input_number.home_energy_hvac_setpoint_increase_f",
  hvacEastEnabled: "input_boolean.home_energy_hvac_east_zone_enabled",
  hvacWestEnabled: "input_boolean.home_energy_hvac_west_zone_enabled",
  hvacUpstairsEnabled: "input_boolean.home_energy_hvac_upstairs_zone_enabled",
  hvacEastMaximum: "input_number.home_energy_hvac_east_maximum_f",
  hvacWestMaximum: "input_number.home_energy_hvac_west_maximum_f",
  hvacUpstairsMaximum: "input_number.home_energy_hvac_upstairs_maximum_f",
  hvacRestoreEnabled: "input_boolean.home_energy_hvac_restore_enabled",
  hvacControllerActive: "input_boolean.home_energy_hvac_controller_active",
  hvacControllerEventKey: "input_text.home_energy_hvac_controller_event_key",
  hvacControllerStatus: "input_text.home_energy_hvac_controller_status",
  hvacEastPrevious: "input_number.home_energy_hvac_east_previous_f",
  hvacEastApplied: "input_number.home_energy_hvac_east_applied_f",
  hvacEastOwned: "input_boolean.home_energy_hvac_east_owned",
  hvacWestPrevious: "input_number.home_energy_hvac_west_previous_f",
  hvacWestApplied: "input_number.home_energy_hvac_west_applied_f",
  hvacWestOwned: "input_boolean.home_energy_hvac_west_owned",
  hvacUpstairsPrevious: "input_number.home_energy_hvac_upstairs_previous_f",
  hvacUpstairsApplied: "input_number.home_energy_hvac_upstairs_applied_f",
  hvacUpstairsOwned: "input_boolean.home_energy_hvac_upstairs_owned",
